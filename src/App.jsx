    ...
    <div class="grid min-h-screen place-items-center">
      <ul class="flex w-full max-w-6xl gap-4">
        {[...Array(4).keys()].map((_, index) => (
          <li
            key={index}
            class="group relative h-[500px] w-full flex-1 overflow-hidden rounded-2xl bg-rose-300 transition-all hover:grow-[1.25]"
          >
            <img
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/70 from-30% p-4">
              <div className="w-48">
                ...
                <div className="grid grid-rows-[0fr] transition-all group-hover:grid-rows-[1fr]">
                  <p className="mt-2 overflow-hidden text-sm text-white/70 opacity-0 transition duration-300 group-hover:opacity-100">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                    Harum facere at unde eius! Excepturi adipisci
                  </p>
                </div>
              </div>
            </div>
